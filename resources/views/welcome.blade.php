...
@section('content')
    ...
    {{-- CONTENT --}}
    <form action="{{ route('frontend.search-flight') }}" method="POST" class="w-full border border-zinc-300 rounded-md p-4 md:p-10 mt-4 md:mt-10 grid grid-cols-1 md:grid-cols-3 gap-5">
        @csrf
        {{-- LEFT --}}
        <div class="w-full grid grid-cols-1 md:grid-cols-2 md:col-span-2 gap-5">
            ...
            <div class="w-full">
                ...
                <div class="mt-1 w-full flex items-center transition-all duration-300 border border-zinc-300 hover:border-green-500 rounded-md">
                    ...
                    {{-- INPUT --}}
                    <select name="kota_asal" id="kota_asal" class="w-full border-none shadow-none outline-none text-sm cursor-pointer">
            ...
            <div class="w-full">
                ...
                <div class="mt-1 w-full flex items-center transition-all duration-300 border border-zinc-300 hover:border-green-500 rounded-md">
                    ...
                    {{-- INPUT --}}
                    <select name="kota_tujuan" id="kota_tujuan" class="w-full border-none shadow-none outline-none text-sm cursor-pointer">
            ...
            <div class="w-full">
                ...
                <div class="mt-1 w-full flex items-center transition-all duration-300 border border-zinc-300 hover:border-green-500 rounded-md">
                    ...
                    {{-- INPUT --}}
                    <input type="date" name="tanggal_berangkat" id="tanggal_berangkat" class="w-full border-none shadow-none outline-none text-sm cursor-pointer">
                </div>
            </div>
            {{-- TANGGAL PULANG --}}
            <div class="w-full">
                ...
                <div class="mt-1 w-full flex items-center transition-all duration-300 border border-zinc-300 hover:border-green-500 rounded-md">
                    ...
                    {{-- INPUT --}}
                    <input type="date" name="tanggal_pulang" id="tanggal_pulang" class="w-full border-none shadow-none outline-none text-sm cursor-pointer">
                </div>
            </div>
        </div>
        {{-- RIGHT --}}
        <div class="w-full grid grid-cols-1 gap-5">
            ...
            <div class="w-full">
                ...
                <div class="mt-1 w-full flex items-center transition-all duration-300 border border-zinc-300 hover:border-green-500 rounded-md">
                    ...
                    {{-- INPUT --}}
                    <select name="kelas_penerbangan" id="kelas_penerbangan" class="w-full border-none shadow-none outline-none text-sm cursor-pointer">
